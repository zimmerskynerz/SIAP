                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button class="btn btn-primary btn-block mb-4 mr-2" data-toggle="modal" data-target="#konfirmasi_pengajuan" type="button">Konfirmasi Pengajuan</button>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
<?php $this->load->view('agendaris/administrasi/pengajuan/detail_data') ?>