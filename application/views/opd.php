...
<head>
    ...
    <!-- SITE TITLE -->
    <title>ALUR PENGADAAN - SIAP KABUPATEN KUDUS</title>
    ...
    <!-- TEMPLATE CSS -->
    <link href="<?= base_url('assets/utama/') ?>css/green.css" rel="stylesheet">
    ...
    <link href="<?= base_url('assets/utama/') ?>css/red.css" rel="alternate stylesheet" title="red-theme">
...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= base_url() ?>" class="primary-color">Home</a></li>
                                    <li class="breadcrumb-item"><a href="#" class="primary-color">Organisasi Perangkat Daerah</a></li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1">
                            ...
                            <div class="single-post-title text-center mb-40">
                                ...
                                <!-- Post Title -->
                                <h3 class="h3-sm">DAFTAR ORGANISASI PERANGKAT DAERAH</h3>
                                <!-- Post Data -->
                                <div class="single-post-data">
                                    <p class="post-meta">Posted by
                                        <a href="#">Kabupaten Kudus</a> on <?= date('Y') ?>
                                    </p>
                                </div>
                            ...
                            <div class="single-post-txt mb-45">
                                ...
                                <!-- Post Text -->
                                <p class="p-md">
                                    Daftar Organisasi perangkat daerah yang sudah terdaftar dalam data server Agendaris SIAP-KUDUS
                                </p>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 col-lg-4">
                            <div class="footer-info mb-40">
                                ...
                                <img src="<?= base_url('assets/utama/') ?>images/logo.png" width="182" height="45" alt="footer-logo">

                                <!-- Text -->
                                <p>Layanan satu atap penyelenggaraan pengadaan barang/jasa lingkup Pemerintah Daerah sesuai dengan ketentuan dan Perundang-undangan yang berlaku.
                                </p>
                        ...
                        <div class="col-md-3 col-lg-2 col-xl-2">
                            <div class="footer-links mb-40">
                                ...
                                <ul class="foo-links clearfix">
                                    ...
                                    <li><a href="<?= base_url('alur-pengajuan') ?>">Alur Pengajuan</a></li>
                                    <li><a href="<?= base_url('daftar-opd') ?>">OPD</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <ul class="bottom-footer-list">
                                    <li>
                                        <p>&copy; Copyright Kabupaten Kudus <?= date('Y') ?></p>
                                    </li>
                                    <li>
                                        <p><a href="tel:0895411547434">+6281-1290-4711</a></p>
                                    </li>
                                    <li>
                                        <p class="last-li"><a href="mailto:yourdomain@mail.com">help@siap.kudus.go.id</a></p>
                                    </li>
                                </ul>
                            </div>
                        </div>
    ...
    <script src="<?= base_url() ?>assets/utama/js/changer.js"></script>
    <script defer src="<?= base_url() ?>assets/utama/js/styleswitch.js"></script>
</body>
