...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>KAJI ULANG PENGADAAN BARANG & JASA</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: center;">Kaji Ulang</th>
                                    ...
                                    foreach ($data_pengajuan as $Data_pengajuan) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url('kepala/administrasi/detailreview/' . $Data_pengajuan->id_pengajuan . '') ?>">
